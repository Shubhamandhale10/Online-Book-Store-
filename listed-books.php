...
<head>
    ...
    <title>E-BOOKLET |  Issued Books</title>
...
<form action="#" method="GET" id="formEdit<?=$SN ?>">
<input type="text" class="product-quantity" name="quantity" value="1" size="2" />
<input type="submit" value="Add to Cart" onclick="alert(' <?php echo htmlentities($result->BookName);?>,<?php echo htmlentities($result->ISBNNumber);?>,<?php echo Date('y/m/d'); ?>,<?php echo Date('y/m/d', strtotime('+3 days')); ?>')" class="btnAddAction" /></div>
</form>
